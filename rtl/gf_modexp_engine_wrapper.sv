// =============================================================================
// gf_modexp_engine_wrapper - Adapts gf_modexp_engine to gf_engine_if
// Copyright (c) 2026 Verily. All rights reserved.
//
// This wrapper connects the existing gf_modexp_engine ports to the formally
// specified gf_engine_if interface. The engine itself is NOT modified.
//
// The multiplier lane is exposed as a pass-through — the chassis connects
// it to the reserved lane in gf_montgomery_cluster.
// =============================================================================
`include "gf_pkg.sv"
...
#(
  ...
  // ─── Txn ID passthrough ──────────────────────────────────────────────────
  // The engine does not carry txn_id internally; the wrapper latches it
  // from the command and presents it on the response.
