...
package gf_pkg;
  ...
  // ---------------------------------------------------------------------------
  // Pre-computed values for common widths (avoid division in synthesis)
  // d=8:   27, d=16:  51, d=64: 190, d=256: 745, d=512: 1481
  parameter int unsigned GF_DIVSTEP_BOUND_8   = 27;
  parameter int unsigned GF_DIVSTEP_BOUND_16  = 51;
  parameter int unsigned GF_DIVSTEP_BOUND_64  = 190;
  parameter int unsigned GF_DIVSTEP_BOUND_256 = 745;
  parameter int unsigned GF_DIVSTEP_BOUND_512 = 1481;
